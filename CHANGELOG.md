...
- `restore` command to recover the data file from recent backups.
- Automatic backup rotation (keeps the latest three backups).

## [v0.5.1] - 2026-01-04

### Added

- `rekey` command to change the data file passphrase.

## [v0.5.0] - 2026-01-04

### Added

- Encrypted data file with passphrase prompts on each run.
- `version` command to print the CLI version.

## [v0.4.0] - 2026-01-04

### Added

- Prompt for a task name when `ttt start` is called without arguments.
- Totals at the end of list and report output.

### Changed

- Status output now includes the start or pause time.
- Start/pause/resume/stop commands print confirmations with timing.
